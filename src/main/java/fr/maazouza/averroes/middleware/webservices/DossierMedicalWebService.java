...
// Pas besoin de faire consulter, car ells sont déjà toutes visible sur le dossier medical
...
//ok
			...
			@Produces(MediaType.APPLICATION_JSON)
			public Maladie obtenirMaladie(
					@QueryParam("idMal") Long idMal)
...
//ok
			...
			public Response modifierMaladie(
					@QueryParam("idMal") Long idMal,
					@QueryParam("idDos") Long idDos,
					@QueryParam("designationMal") String designationMal,
					@QueryParam("descriptionMal") String descriptionMal,
				...
				try{
					...
					return Response.status(200)
							.entity("La maladie   "+ idMal+" a été modifiée ")
							.build();
...
// Supprimer une maladie d'un dossier medical d'un patient
						...
						public Response supprimerMaladie(
								@QueryParam("idMal") Long idMal)
								...
								return Response.status(200)
										.entity("La maladie   "+ idMal+" a été supprimée au dossier ")
										.build();
								}
